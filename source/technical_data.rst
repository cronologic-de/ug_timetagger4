...
Ech board is tested against the values listed in the columns “Min” and “Max”.
“Typical” is the mean value of the first 10 boards produced or a value that is
set by design.
...
Any voltage on the inputs above 5 V or below −5 V relative to the voltage of the slot
cover can result in permanent damage to the board.
