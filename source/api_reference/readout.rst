...
.. c:struct:: timetagger4_read_out
    ...
    .. c:member:: int error_code
        ...
        .. c:macro:: CRONO_READ_NO_DATA
            ...
            The pointers :c:member:`timetagger4_read_out.first_packet` and
            :c:member:`timetagger4_read_out.last_packet` will not point to valid packets
            in memory.

        .. c:macro:: CRONO_READ_INTERNAL_ERROR

            Evaluates to ``2``. Some unhandled error occurred.
            The TimeTagger4 device needs to be reinitialized.
        ...
        .. c:macro:: CRONO_READ_WRONG_STATE
            ...
            Evaluates to ``4``. The TimeTagger4 is in a wrong state
