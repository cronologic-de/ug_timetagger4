...
.. c:struct:: crono_packet
    ...
    .. c:member:: uint8_t channel
        ...
        Always 0 for the TimeTagger4.

        The channel source of a hit are encoded in :c:member:`data`.

    .. c:member:: uint8_t card

        Identifies the source card of the data, in case multiple TimeTagger4
        are installed in the system.

        Defaults to 0 if no value is assigned to
        :c:member:`timetagger4_init_parameters.board_id`.

    .. c:member:: uint8_t type

        The type of :c:member:`crono_packet.data`.

        In case of the TimeTagger4, this is always an 32-bit unsigned integer,
    ...
    .. c:member:: uint8_t flags
        ...
        .. c:macro:: TIMETAGGER4_PACKET_FLAG_HOST_BUFFER_FULL
            ...
            (see :c:member:`timetagger4_init_parameters.buffer_size`) or
    ...
    .. c:member:: uint32_t length
        ...
        | 2 :math:`\times` :c:member:`length` – ((:c:member:`flags` &
            :c:macro:`TIMETAGGER4_PACKET_FLAG_ODD_HITS <flags.TIMETAGGER4_PACKET_FLAG_ODD_HITS>`)
            ? 1 : 0)

    .. c:member:: uint64_t timestamp

        Coarse timestamp of the Start trigger hit. Values are given in multiples
        of :c:member:`timetagger4_param_info.packet_binsize`.
    ...
    .. c:member:: uint64_t data[1]
        ...
        :c:member:`timetagger4_param_info.packet_binsize`.
        ...
        .. c:macro:: TIMETAGGER4_HIT_FLAG_TIME_OVERFLOW
            ...
            :c:member:`timetagger4_static_info.rollover_period`.
