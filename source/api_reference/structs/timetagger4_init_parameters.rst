.. c:struct:: timetagger4_init_parameters
    ...
    :c:func:`timetagger4_get_default_init_parameters`, then adjust parameters
    for your use case.
    ...
    .. c:member:: int version
        ...
        Must be set to :c:macro:`TIMETAGGER4_API_VERSION`.
    ...
    .. c:member:: int card_index
        ...
        the driver as reported by :c:func:`timetagger4_count_devices`. This index
        selects one of them.
    ...
    .. c:member:: int buffer_type
        ...
        .. c:macro:: TIMETAGGER4_BUFFER_ALLOCATE

            Use allocated buffer.

        .. c:macro:: TIMETAGGER4_BUFFER_USE_PHYSICAL
    ...
    .. c:member:: int device_type
        ...
        Initialized by :c:func:`timetagger4_get_default_init_parameters`
        to :c:macro:`CRONO_DEVICE_TIMETAGGER4`.
